...
import { computeCleaningEvents } from "../cleaningUtils.js";

const DEFAULT_CLEAN_RATES = {
  fullClean: 60,
  beddingChange: 0,
  beddingInterval: 4,
};
...
export default function Owners() {
  ...
  const addApartment = () => {
    ...
    setApartments((prev) => [
      ...prev,
      { id, name, notes: "", owner: "", ownerPhone: "", ama: "" },
    ]);
    markDirty();
    setNewAptName("");
  };
  ...
  const saveApartment = () => {
    ...
    setApartments((prev) =>
      prev.map((a) => (a.id === editApt.id ? { ...editApt } : a)),
    );
    markDirty();
    setEditApt(null);
  };
  ...
  // ── Accountant ────────────────────────────────────────────────────────────
  const [accountantDraft, setAccountantDraft] = useState(null); // null = view mode

  const saveAccountant = () => {
    setAccountant(accountantDraft);
    markDirty();
    setAccountantDraft(null);
  };
  ...
  const shares = Object.fromEntries(
    apartments.map((a) => [a.id, a.shares || {}]),
  );
  ...
  const setShare = (aptId, personId, val) => {
    ...
    setApartments((prev) =>
      prev.map((a) =>
        a.id === aptId
          ? { ...a, shares: { ...(a.shares || {}), [personId]: pct } }
          : a,
      ),
    );
    markDirty();
  ...
  apartments.forEach((apt) => {
    aptShareTotals[apt.id] = people.reduce(
      (s, p) => s + (shares[apt.id]?.[p.id] || 0),
      0,
    );
  });
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
        ...
        <div className="space-y-2 mb-4">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        autoFocus
                        onChange={(e) =>
                          setEditApt((a) => ({ ...a, name: e.target.value }))
                        }
                        onKeyDown={(e) => {
                          if (e.key === "Escape") setEditApt(null);
                        }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={editApt.owner ?? ""}
                        onChange={(e) =>
                          setEditApt((a) => ({ ...a, owner: e.target.value }))
                        }
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        type="text"
                        value={editApt.ownerPhone ?? ""}
                        onChange={(e) =>
                          setEditApt((a) => ({
                            ...a,
                            ownerPhone: fmtPhone(e.target.value),
                          }))
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={editApt.notes ?? ""}
                        onChange={(e) =>
                          setEditApt((a) => ({ ...a, notes: e.target.value }))
                        }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={editApt.ama ?? ""}
                      onChange={(e) =>
                        setEditApt((a) => ({ ...a, ama: e.target.value }))
                      }
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 border border-slate-200 text-slate-600 rounded text-sm hover:bg-slate-50"
                    >
                      Cancel
                    </button>
                  </div>
          ...
          {apartments.length === 0 && (
            <p className="text-sm text-slate-400">No apartments added yet.</p>
          )}
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-4">
        ...
        {managerDraft ? (
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  autoFocus
                  onChange={(e) =>
                    setManagerDraft((m) => ({ ...m, name: e.target.value }))
                  }
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setManagerDraft({ ...manager })}
              className="text-xs text-slate-400 hover:text-blue-600"
            >
              Edit
            </button>
      ...
      {/* ── Accountant ───────────────────────────────────────────────────── */}
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-4">
        <h3 className="font-semibold text-slate-800 mb-3">Accountant</h3>
        ...
        {accountantDraft ? (
          <div className="space-y-2">
            <div>
              ...
              <input
                type="text"
                value={accountantDraft.name}
                autoFocus
                onChange={(e) =>
                  setAccountantDraft((a) => ({ ...a, name: e.target.value }))
                }
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  type="text"
                  value={accountantDraft.phone ?? ""}
                  onChange={(e) =>
                    setAccountantDraft((a) => ({
                      ...a,
                      phone: fmtPhone(e.target.value),
                    }))
                  }
              ...
              <div>
                ...
                <input
                  type="email"
                  value={accountantDraft.email ?? ""}
                  onChange={(e) =>
                    setAccountantDraft((a) => ({ ...a, email: e.target.value }))
                  }
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => setAccountantDraft(null)}
                className="px-3 py-1 border border-slate-200 text-slate-600 rounded text-sm hover:bg-slate-50"
              >
                Cancel
              </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setAccountantDraft({ ...accountant })}
              className="text-xs text-slate-400 hover:text-blue-600"
            >
              Edit
            </button>
      ...
      {people.length > 0 && (
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
          ...
          <p className="text-xs text-slate-400 mb-4">
            Set each person's percentage per apartment. Shares should add up to
            100%.
          </p>
              ...
              return (
                <div key={apt.id}>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span
                      className={`text-xs px-1.5 py-0.5 rounded ${ok ? "bg-green-100 text-green-700" : "bg-amber-100 text-amber-700"}`}
                    >
                    ...
                    {people.map((person) => (
                      <div key={person.id} className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setShare(apt.id, person.id, e.target.value)
                          }
                          placeholder="0"
              ...
              <thead>
                <tr className="border-b border-slate-100 text-xs text-slate-500 uppercase tracking-wide">
                  ...
                  {apartments.map((apt) => (
                    <th
                      key={apt.id}
                      className="py-2 text-right font-medium px-3"
                    >
                      {apt.name}
                ...
                {personTotals.map((person) => (
                  ...
                  >
                    ...
                    {apartments.map((apt) => (
                      <td
                        key={apt.id}
                        className="py-3 text-right text-slate-600 px-3"
                      >
                        <span className="font-medium">
                          {fmt(person.byApt[apt.id] || 0)}
                        </span>
                    ...
                    <td className="py-3 text-right font-semibold text-slate-700 px-3">
                      {fmt(person.net)}
                    </td>
