...
export default function App() {
  ...
  const handlePush = useCallback(async () => {
    ...
    setPushError('');
    try {
      await saveAllData({ bookings, expenses, expenseCategories, apartments, manager, consumables, cleaning }, token, config);
      localStorage.setItem('data_cache', JSON.stringify({ bookings, expenses, expenseCategories, apartments, manager, consumables, cleaning }));
  ...
  }, [bookings, expenses, expenseCategories, apartments, manager, consumables, cleaning, token, config]);
